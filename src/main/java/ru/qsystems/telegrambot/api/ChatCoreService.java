...
public class ChatCoreService {
    ...
    public CoreResponse initialize(@Nullable InitRequest request) {
        ...
        return enrich(new CoreResponse(session.sessionId, session.visitorId, "Выберите действие:", List.of(new CoreOption("take-ticket", "Получить талон")), false, null, null));
    }
